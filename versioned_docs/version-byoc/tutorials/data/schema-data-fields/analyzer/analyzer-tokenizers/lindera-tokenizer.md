...
beta: FALSE
notebook: FALSE
description: "The `lindera` tokenizer performs dictionary-based morphological analysis. It is designed for Japanese and Korean—languages where words are not separated by spaces and grammatical markers (particles) attach directly to words. | BYOC"
type: origin
