...
notebook: FALSE
description: "Use an OpenAI embedding model with Zilliz Cloud by choosing an embedding model and creating a collection with a text embedding function. | BYOC"
type: origin
