...
beta: FALSE
notebook: FALSE
description: "Zilliz Cloud のごみ箱機能は、意図的に削除された場合やトライアルの期限切れ、サービスの停止によって削除された場合を含め、すべての Serverless および Dedicated クラスターの記録を保持することでデータを保護します。気が変わった場合や誤ってクラスターを削除してしまった場合、ごみ箱ではクラスターの復元に30日間の猶予期間が提供されます。"
type: origin
