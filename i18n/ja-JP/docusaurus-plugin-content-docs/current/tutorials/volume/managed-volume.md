...
beta: FALSE
notebook: FALSE
description: "マネージドボリュームは、インポートおよび移行で使用されるデータファイルを保持するための、Zilliz Cloud がホストするオブジェクトストレージです。このページでは、Web コンソールおよび SDK を使用してマネージドボリュームを作成、管理、削除する方法を説明します。 | Cloud"
type: origin
...
<table>
   ...
   <tr>
     <td><p><strong>アップロードごとのファイルサイズとファイル数</strong></p></td>
     <td><p>最大 1 GB のデータ、各アップロードあたり最大 1,000 ファイル</p></td>
     <td><p>最大 100 GB のデータ、各アップロードあたりファイル数無制限</p></td>
   </tr>
   <tr>
