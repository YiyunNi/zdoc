---
title: "Milvus からバックアップファイルを介して Zilliz Cloud に移行 | Cloud"
slug: /via-backup-files
sidebar_key: via-backup-files
sidebar_label: "バックアップファイルを介して"
beta: FALSE
notebook: FALSE
description: "Zilliz Cloud は、インフラストラクチャの管理を自分で行いたくないユーザー向けに、Milvus をフルマネージドのクラウドホスト型ソリューションとして提供しています。このトピックでは、バックアップファイルを直接アップロードして Milvus から移行する方法について説明します。"
type: origin
