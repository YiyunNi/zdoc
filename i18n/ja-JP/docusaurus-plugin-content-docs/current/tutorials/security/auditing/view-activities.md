...
beta: FALSE
notebook: FALSE
description: "Zilliz Cloudプラットフォーム監査ログ機能は、特定のZilliz Cloud組織に関連するログの包括的なビューを提供し、請求ログとアクセスログを含みます。"
type: origin
...
Zilliz Cloudの**プラットフォーム監査ログ**機能は、特定のZilliz Cloud組織に関連するログの包括的なビューを提供し、請求およびアクセスログを網羅しています。
...
- **時間範囲でフィルタリング**
    ...
    特定の期間内に発生したログを表示するには、開始日と終了日を選択します。希望する時間範囲を設定したら、**適用**をクリックしてこの期間内のすべてのログを表示します。
...
- **タイプでフィルタリング**
    ...
    <table>
       ...
       <tr>
         <td><p>警告</p></td>
         <td><p>注意が必要なリソースの状態に関する更新。</p><p>例：「クラスター in01-xxxxxxxxxxxxxxx が削除されました。」</p></td>
       </tr>
       <tr>
         <td><p>エラー</p></td>
         <td><p>支払い失敗やその他のシステム障害に関する通知で、即座の注意またはアクションが必要です。</p><p>例：「請求書 invo-xxxxxxxxxxxxxxxxxxxxxxxx の支払いが失敗しました。」</p></td>
       </tr>
    </table>
