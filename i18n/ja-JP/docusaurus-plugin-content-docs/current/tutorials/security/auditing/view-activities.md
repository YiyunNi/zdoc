...
組織ページで、左側のナビゲーションペインから **プラットフォーム監査ログ** をクリックします。ここでは、プラットフォームログの概要、各ログが記録された時間、および関与したオペレーターの識別情報を確認できます。
...
- **タイプでフィルタリング**
    ...
    <table>
       ...
       <tr>
         <td><p>情報</p></td>
         <td><p>クラスター、アクセス、または課金に関連する一般情報。</p><p>例: クラスター in01-xxxxxxxxxxxxxxx が作成されました。</p></td>
       </tr>
       <tr>
         <td><p>警告</p></td>
       ...
       <tr>
         <td><p>エラー</p></td>
         <td><p>即時の注意または対応が必要な支払い失敗やその他のシステム障害の通知。</p><p>例: 「請求書 invo-xxxxxxxxxxxxxxxxxxxxxxxx の支払いが失敗しました。」</p></td>
       </tr>
    </table>
