...
beta: FALSE
notebook: FALSE
description: "`icu` トークナイザーは、ソフトウェアの国際化のための主要なツールを提供する Unicode オープンソースプロジェクトの国際化コンポーネントに基づいて構築されています。ICU の単語分割アルゴリズムを使用することで、このトークナイザーは世界のほとんどの言語でテキストを正確に単語に分割できます。 | Cloud"
type: origin
