...
<p>このフィルターは、句読点を個別のトークンとして保持する <code>jieba</code>、<code>lindera</code>、および <code>icu</code> トークナイザーで最も効果的です (例: <code>"Hello!"</code> → <code>["Hello", "!"]</code>)。<code>standard</code> や <code>whitespace</code> などの他のトークナイザーは、トークン化中に句読点を破棄するため、<code>removepunct</code> はそれらに影響を与えません。</p>
