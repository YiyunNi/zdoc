...
beta: FALSE
notebook: FALSE
description: "Zilliz Cloud のコレクションでは、検索またはクエリ結果で最大 16,384 件のエンティティを取得できます。topK の制限を超えてより多くのエンティティを取得するには、クエリモードを設定して、複雑で時間のかかるイテレータを使用する代わりに、1 回の検索またはクエリ結果に数百万件のエンティティを含めることができます。"
type: origin
