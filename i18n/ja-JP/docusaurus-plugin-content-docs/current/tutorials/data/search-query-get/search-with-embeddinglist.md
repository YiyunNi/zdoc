---
title: "埋め込みリストによる検索 | Cloud"
slug: /search-with-embeddinglist
sidebar_label: "埋め込みリスト"
beta: FALSE
notebook: FALSE
description: "このページでは、Zilliz Cloud の構造体配列を使用して ColBERT テキスト検索システムと ColPali テキスト検索システムを設定する方法について説明します。これにより、ドキュメントとそのベクトル化されたチャンクを埋め込みリストに格納できます。 | Cloud"
type: origin
