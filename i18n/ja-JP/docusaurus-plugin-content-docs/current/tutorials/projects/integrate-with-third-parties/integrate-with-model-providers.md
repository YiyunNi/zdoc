...
beta: FALSE
notebook: FALSE
description: "モデルプロバイダー統合は、Zilliz Cloudをサードパーティのモデルサービスに接続し、プロバイダーの機能をプロジェクトで利用できるようにします。 | Cloud"
type: origin
...
<p>統合が削除されたり無効になったりした場合、それを参照するコレクションやランカーは、統合が更新または置き換えられるまで、挿入または検索操作中に失敗する可能性があります。</p>
