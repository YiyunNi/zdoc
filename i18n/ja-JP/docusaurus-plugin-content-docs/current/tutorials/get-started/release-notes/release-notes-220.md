...
beta: FALSE
notebook: FALSE
description: "Zilliz Cloud の新バージョンをリリースしました。本アップデートでは、ユーザー体験を向上させるための新機能を多数搭載しています。これには、Zilliz Cloud クラスター間および ElasticSearch からのデータ移行、新しいチケットシステムの稼働、そして強化されたデータインポート機能が含まれます。 | Cloud"
type: origin
