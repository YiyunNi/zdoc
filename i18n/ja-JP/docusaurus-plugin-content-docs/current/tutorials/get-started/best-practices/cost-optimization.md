...
<table>
    ...
    <tr>
        ...
        <td><p>—</p></td>
        <td><p>1 年に延長</p></td>
        <td><p>未使用のクレジットは、支払い方法を追加すると自動的に延長されます</p></td>
    </tr>
    <tr>
        <td><p>ごみ箱</p></td>
        <td><p>無料</p></td>
...
<table>
    ...
    <tr>
        ...
        <td><p><a href="https://zilliz.com/zilliz-for-startups">公式サイト</a>から申請して、追加クレジットと技術サポートを受け取ります</p></td>
    </tr>
    <tr>
...
- **営業担当者へのお問い合わせによるカスタム見積もり:** エンタープライズ顧客は年間サブスクリプションを通じて割引を受けられます。具体的な価格については [営業担当者にお問い合わせください](https://zilliz.com/contact-sales)。
...
- **前払い:** [前払い](./advance-pay) でアカウントに資金を入金できます。控除優先順位は以下の通りです：クレジット > 前払い > クラウドマーケットプレイスサブスクリプション/クレジットカード。予算管理要件のある組織に適しています。
...
<table>
   ...
   <tr>
     <td><p>プロジェクト</p></td>
     <td><p>異なる事業ラインや部門間の使用状況を比較</p></td>
   </tr>
   <tr>
     <td><p>クラスター</p></td>
   ...
   <tr>
     <td><p>クラウドリージョン</p></td>
     <td><p>マルチリージョン展開におけるリージョン間のコストを比較</p></td>
   </tr>
</table>
...
[Query Daily Usage](/reference/restful/query-daily-usage-v2) API は、最大小数点以下 8 桁の精度で使用状況データを提供し、内部的な FinOps ワークフローにプログラム的に統合して以下のことを行えます。
...
1. **エラスティックスケーリングを使用する** — アイドル状態のリソースに対する支払いを止め、30〜40% を節約します。
