...
1. クラスターまたはコレクションのバックアップを作成する。
    ...
    バックアップは、クラスターまたはコレクションの特定時点のコピーです。バックアップは [手動で作成](./create-backup) することも、[バックアップポリシーを設定](./schedule-automatic-backups) してスケジュールされたバックアップを行うこともできます。また、災害復旧能力を向上させるために [他のリージョンにバックアップをコピー](/docs/backup-to-other-regions) することもできます。
