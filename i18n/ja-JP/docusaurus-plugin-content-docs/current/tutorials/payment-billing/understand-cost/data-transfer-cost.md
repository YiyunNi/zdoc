...
beta: FALSE
notebook: FALSE
description: "データ転送には、Zilliz Cloud への流入、Zilliz Cloud からインターネットへの流出、または Zilliz Cloud 内の2つのリソース間の通信が含まれます。Zilliz Cloud のデータ転送費用は、転送されたデータ量に基づいて課金されます。 | Cloud"
type: origin
