...
beta: FALSE
notebook: FALSE
description: "Zilliz Cloud では、ユーザーをプロジェクトに招待し、職務に基づいてロールを割り当てることができます。これらのロールは、プロジェクトリソースへのアクセス権限と実行可能な操作を決定します。| BYOC"
type: origin
...
<p>プロジェクトから離脱すると、そのプロジェクトおよび関連リソースへのアクセス権は取り消されます。</p>
