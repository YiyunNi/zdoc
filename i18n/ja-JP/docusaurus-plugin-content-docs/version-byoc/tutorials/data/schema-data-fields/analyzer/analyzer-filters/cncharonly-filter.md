...
beta: FALSE
notebook: FALSE
description: "`cncharonly` フィルターは、中国語以外の文字を含むトークンを削除します。このフィルターは、中国語のテキストのみに焦点を当て、他のスクリプト、数字、記号を含むトークンを除外したい場合に役立ちます。 | BYOC"
type: origin
...
`cncharonly` フィルターは、中国語以外の文字を含むトークンを削除します。このフィルターは、中国語のテキストのみに焦点を当て、他のスクリプト、数字、または記号を含むトークンを除外したい場合に便利です。
