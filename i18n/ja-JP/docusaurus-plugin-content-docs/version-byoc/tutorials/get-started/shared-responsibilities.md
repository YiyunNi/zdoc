...
beta: CONTACT SALES
notebook: FALSE
description: "このページでは、クラウド管理、アップグレード、セキュリティ、アクセス制御、サービスの可用性、技術サポートに関連するタスクの分担を明確にし、安全で効率的な運用環境を維持しながら円滑な連携を実現するために、Zilliz Cloud と BYOC ユーザーのそれぞれの責任について説明します。 | BYOC"
type: origin
