...
beta: FALSE
notebook: FALSE
description: "Zilliz Cloud は、Bring Your Own Cloud (BYOC) オーガニゼーション向けのライセンスを提供します。ライセンスが有効な間、Zilliz Cloud はオーガニゼーションで使用されている vCPU の数に基づいて課金し、その金額をライセンス容量から差し引きます。| BYOC"
type: origin
