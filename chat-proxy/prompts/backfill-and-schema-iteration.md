# Seamless Backfill and Schema Iteration Prompt
...
1. tell me whether my task is a good fit for Backfill
2. tell me whether the requested field type and operation are supported
3. tell me what input data I need to prepare
4. tell me whether field mapping is required
5. recommend the correct backfill mode
6. explain what happens to matched PKs, unmatched PKs, NULL values, and existing non-NULL values
7. explain online impact and post-commit visibility
8. call out unsupported cases and common mistakes
