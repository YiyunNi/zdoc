...
```bash
zilliz completion install <SHELL> [OPTIONS]
```
...
- **SHELL** (*string*) -
    ...
    Indicates the target shell for the installation. Choices: `bash`, `zsh`, `fish`. The current shell applies if this is not specified.

- **--apply** (*boolean*) -

    Indicates whether to automatically write to the rc file of the specified shell.
