...
<p>Zilliz Cloud provides dedicated integration guides for <a href="./single-sign-on-with-microsoft-entra">Okta</a>, <a href="./single-sign-on-with-okta">Google Workspace</a>, and <a href="./single-sign-on-with-google-workspace">Microsoft Entra</a>, but any standards-compliant SAML 2.0 IdP can be used with the <strong>Other IdP (SAML 2.0)</strong> option.</p>
