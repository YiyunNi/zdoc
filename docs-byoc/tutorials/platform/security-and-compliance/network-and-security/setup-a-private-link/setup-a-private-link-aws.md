...
- You have already created a VPC Endpoint using AWS CloudFormation, [AWS Console](./configure-vpc#step-3-optional-create-a-vpc-endpoint), or the Terraform scripts.
...
- **Create a hosted zone using Amazon Route 53**
    ...
    ![O8dObi5aBogsL1xDBY4cgEtInCb](https://zdoc-images.s3.us-west-2.amazonaws.com/o8dobi5abogsl1xdby4cgetincb.png "O8dObi5aBogsL1xDBY4cgEtInCb")
...
- **Create an alias record in the hosted zone**
    ...
    ![KVjsbqBGRofmmxxmqvBccvOanDf](https://zdoc-images.s3.us-west-2.amazonaws.com/kvjsbqbgrofmmxxmqvbccvoandf.png "KVjsbqBGRofmmxxmqvBccvOanDf")
