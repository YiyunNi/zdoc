...
When inserting or upserting data, you will receive this error because your data exceeds the serving cluster CU capacity.  The capacity of a cluster depends on its [cluster type and CU size](./select-the-right-cluster-type#assess-capacity).
