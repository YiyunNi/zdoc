...
If you are an organization owner, you can invite users to your organization. Refer to [Manage Organization Users](./manage-organization-users) for more detailed instructions.

If you are an organization member, you can contact your organization owner to invite other users.

Additionally, Zilliz Cloud also supports inviting users to projects. If you are a project admin, you can invite other project users to your project. Refer to [Manage Project Users](./manage-project-users) for more detailed instructions.
