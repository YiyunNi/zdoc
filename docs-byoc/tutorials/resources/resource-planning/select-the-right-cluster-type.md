...
slug: /select-the-right-cluster-type
sidebar_label: "Select the Right Cluster Type"
beta: FALSE
added_since: FALSE
last_modified: FALSE
...
The following table offers a quick comparison of the three cluster types in different aspects. For a detailed comparison in terms of the capacity and performance among the cluster types, please proceed to [Select an optimal cluster type](./select-the-right-cluster-type#select-an-optimal-cluster-type).
