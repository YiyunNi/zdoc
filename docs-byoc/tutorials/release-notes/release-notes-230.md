---
title: "Release Notes (Oct 17, 2023) | BYOC"
...
- *New Role for RBAC*
    ...
    Grant [Project Member Role](./manage-project-users) to project collaborators for more streamlined collaboration.
...
- *Self-Service Account Deletion*
    ...
    Easily [delete your own accounts](./email-accounts#close-your-account) or [organizations](./undefined#delete-organization) for greater control over your profile.
