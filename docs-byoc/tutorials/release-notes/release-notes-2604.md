---
title: "April 2026 Release Notes | BYOC"
slug: /release-notes-2604
sidebar_label: "April 2026 Release Notes"
beta: FALSE
added_since: FALSE
last_modified: FALSE
deprecate_since: FALSE
notebook: FALSE
description: "April 2026 Release Notes | BYOC"
type: origin
...
<Grid columnSize="2" widthRatios="20,80">
    ...
    <div>
        ...
        The maintenance window experience has been redesigned with extended 4-hour minimum duration, email and in-console notifications at 7/3/1 days before upgrades, the ability to defer upgrades by 7 days, and availability for all Business Critical and Enterprise plans.For details, refer to [Configure Maintenance Windows](./undefined#set-up-preferred-maintenance-window).
        ...
        - Note: Customized API Keys do not currently support the Cluster Admin role. For details, refer to [Manage Project Users](./manage-project-users).
