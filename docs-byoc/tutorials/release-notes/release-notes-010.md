---
title: "Release Notes (Jan 10, 2023) | BYOC"
...
notebook: FALSE
description: "We are pleased to announce the general availability of a significant update to Zilliz Cloud. This release adds the data preview feature and a demo dataset that can be easily imported into your collection on the console. | BYOC"
type: origin
