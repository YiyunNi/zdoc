...
notebook: FALSE
description: "Last updated April 11, 2026 | BYOC"
type: origin
...
<Grid columnSize="2" widthRatios="25,74">
    ...
    <div>
        ...
        - ⚙️ The [maintenance window](./undefined#set-up-preferred-maintenance-window) has been redesigned to provide more predictable upgrade scheduling and proactive notifications.

        - 👥 A new [cluster admin](./manage-project-users#cluster-admin) role grants team members operational access to specific clusters without full project-level admin privileges.
...
<Grid columnSize="2" widthRatios="25,74">
    ...
    <div>
        ...
        - 👥 Cluster-level access control configured at the [organization-](./manage-organization-users#organization-role) and [project-level](./manage-project-users#project-access) for fine-grained data access.
...
<Grid columnSize="2" widthRatios="25,74">
    ...
    <div>
        ...
        - 🤖 Model-based embedding and [reranking functions](./model-based-rankers) for public preview.
...
<Grid columnSize="2" widthRatios="25,74">
    ...
    <div>
        ...
        - 💾  Tiered storage becomes GA, and [billing starts](./audit-log-cost)
...
<Grid columnSize="2" widthRatios="25,74">
    ...
    <div>
        ...
        - 🔄  Data migration with expanded sources: 
            ...
            - [Tencent Cloud](./migrate-from-pgvector)
...
<Grid columnSize="2" widthRatios="25,74">
    ...
    <div>
        ...
        - 📦  Migration service for you to migrate data to Zilliz Cloud:
            ...
            - [PostgreSQL](./migrate-from-tencent-cloud), and
...
<Grid columnSize="2" widthRatios="25,74">
    ...
    <div>
        ...
        - 🚀  Milvus v2.4.x becomes available on the Zilliz Cloud
            ...
            - Inverted index and [fuzzy match](./basic-filtering-operators#example-2-using-like-for-pattern-matching)
...
<Grid columnSize="2" widthRatios="25,74">
    ...
    <div>
        ...
        - [⏰  Custom timezone](./undefined#manage-timezone)
...
<Grid columnSize="2" widthRatios="25,74">
    ...
    <div>
        ...
        - [⚙️  System maintenance settings](./undefined) become available
