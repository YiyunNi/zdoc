---
title: "Release Notes (April 6, 2023) | BYOC"
...
notebook: FALSE
description: "We're thrilled to unveil the newest Zilliz Cloud update, featuring a pricing calculator for cost estimation, a data backup and restore process for enhanced data security, a customizable timezone setting for global users, a collection rename tool for better organization, the removal of storage quotas for unrestricted usage, and improved credit conservation for inactive databases. | BYOC"
type: origin
...
- Custom Timezone
    ...
    For details, refer to [Manage Timezone](./undefined#manage-timezone).
