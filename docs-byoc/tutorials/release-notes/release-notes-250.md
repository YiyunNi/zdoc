---
title: "Release Notes (Jan 18, 2024) | BYOC"
...
notebook: FALSE
description: "Zilliz Cloud have optimized the user experience for data import features, refined API keys with hierarchical permissions, and enhanced the metrics and alerts mechanism. | BYOC"
type: origin
