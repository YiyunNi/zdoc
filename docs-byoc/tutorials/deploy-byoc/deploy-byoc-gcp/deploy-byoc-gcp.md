...
Once you have deployed the project's data plane and created clusters, you can connect to these clusters either through direct VPC access or via GCP Private Service Connect. For details, refer to Connect to BYOC Clusters.
