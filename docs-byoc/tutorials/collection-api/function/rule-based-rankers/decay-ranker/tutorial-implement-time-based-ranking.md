---
title: "Tutorial: Implement Time-based Ranking | BYOC"
...
# Tutorial: Implement Time-based Ranking

In many search applications, the freshness of content is just as important as its relevance. News articles, product listings, social media posts, and research papers all benefit from ranking systems that balance semantic relevance with recency. This tutorial demonstrates how to implement time-based ranking in Zilliz Cloud using decay rankers.

## Understand decay rankers\{#understand-decay-rankers}
...
Zilliz Cloud supports three types of decay rankers:
...
Each ranker has different characteristics that make them suitable for various use cases. For more information, refer to [Decay Ranker Overview](./decay-ranker-overview).

## Build a time-aware search system\{#build-a-time-aware-search-system}
...
## Step 1: Design the schema\{#step-1-design-the-schema}
...
## Step 2: Set up embedding functions\{#step-2-set-up-embedding-functions}
...
## Step 4: Prepare sample data\{#step-4-prepare-sample-data}
...
## Step 5: Configure different decay rankers\{#step-5-configure-different-decay-rankers}
...
## Step 6: Visualize the decay rankers\{#step-6-visualize-the-decay-rankers}
...
## Step 7: Helper function for results display\{#step-7-helper-function-for-results-display}
...
## Step 8: Compare standard vs. decay-based search\{#step-8-compare-standard-vs-decay-based-search}
...
## Step 9: Understand score calculation\{#step-9-understand-score-calculation}
...
## Step 10: Hybrid search with time decay\{#step-10-hybrid-search-with-time-decay}
...
## Step 12: Testing with different queries\{#step-12-testing-with-different-queries}
