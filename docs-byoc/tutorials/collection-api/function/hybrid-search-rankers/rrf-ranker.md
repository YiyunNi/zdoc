...
<table>
   ...
   <tr>
     ...
     <td><p>No</p></td>
     <td><p>Smoothing parameter that controls the impact of document ranks; higher <code>k</code> reduces sensitivity to top ranks. Range: (0, 16384); default: <code>60</code>.</p><p>For details, refer to <a href="./rrf-ranker#mechanism-of-rrf-ranker">Mechanism of RRF Ranker</a>.</p></td>
