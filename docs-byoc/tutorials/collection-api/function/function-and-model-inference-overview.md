...
sidebar_label: "Function & Model Inference Overview"
beta: FALSE
added_since: FALSE
last_modified: FALSE
...
<table>
   ...
   <tr>
     ...
     <td><p>Combine and rebalance results retrieved from different retrieval strategies using methods such as <a href="./weighted-ranker">weighted ranking</a> or <a href="./rrf-ranker">reciprocal rank fusion</a> (RRF).</p></td>
   ...
   <tr>
     ...
     <td><p>Adjust ranking based on predefined rules or numeric signals, such as <a href="./boost-ranker">boosting</a> or <a href="./decay-ranker-overview">decay-based</a> scoring.</p></td>
