...
slug: /hybrid-search
sidebar_label: "Multi-Vector Hybrid Search"
beta: FALSE
added_since: FALSE
last_modified: FALSE
...
To merge and rerank the sets of ANN search results, selecting an appropriate reranking strategy is essential. Zilliz Cloud offers several types of reranking strategies. For more details on these reranking mechanisms, please refer to [Weighted Ranker](./weighted-ranker) or [RRF Ranker](./rrf-ranker). 
