...
notebook: FALSE
description: "Search Aggregation extends vector search with grouped results. It organizes retrieved entities into groups based on scalar field values and can return both representative hits and group-level statistics. | BYOC"
type: origin
