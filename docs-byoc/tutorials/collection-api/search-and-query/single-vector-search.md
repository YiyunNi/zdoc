...
For details on AUTOINDEX and applicable metric types, refer to [AUTOINDEX Explained](./autoindex-explained) and Metric Types. In this section, you will find detailed information about the following topics:
...
## Sort Search Results by Scalar Fields | Private Preview\{#sort-search-results-by-scalar-fields}
