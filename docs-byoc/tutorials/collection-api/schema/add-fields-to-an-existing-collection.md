...
<p>Refer to our <a href="./create-a-managed-collection">Create Collection</a> for collection creation and basic operations.</p>
...
- **New collection**: Set `enable_dynamic_field` to True when creating the collection. For details, refer to [Create Collection](./create-a-managed-collection#create-schema)
