module.exports = [
  ...
  {
    "type": "doc",
    "id": "tutorials/what-is-vector-lakebase",
    "label": "What is Vector Lakebase?"
  },
  {
    "type": "category",
    "label": "Concepts",
    "items": [
      {
        "type": "doc",
        "id": "tutorials/concepts/compute-realtime-serving-and-on-demand-compute",
        "label": "Compute: Realtime Serving & On-demand Compute"
      },
      {
        "type": "doc",
        "id": "tutorials/concepts/storage-external-and-managed-volumes",
        "label": "Storage: External & Managed Volumes"
      },
      {
        "type": "doc",
        "id": "tutorials/concepts/data-external-and-managed-collections",
        "label": "Data: External & Managed Collections"
      },
      {
        "type": "doc",
        "id": "tutorials/concepts/access-connection-endpoints",
        "label": "Access: Connection Endpoints"
      }
    ]
  },
  {
    ...
    "items": [
      ...
      {
        "type": "doc",
        "id": "tutorials/quickstarts/how-to-connect",
    ...
    "items": [
      {
        ...
        "items": [
          ...
          {
            "type": "doc",
            "id": "tutorials/collection-api/search-and-query/semantic-highlighter",
      ...
      },
      {
        ...
        "items": [
          ...
          {
            "type": "doc",
            "id": "tutorials/collection-api/collection/create-an-external-collection",
      ...
      },
      {
        ...
        "items": [
          ...
          {
            "type": "category",
            "label": "Model-based Embeding Functions",
            "items": [
              {
                "type": "doc",
                "id": "tutorials/collection-api/function/model-based-embeding-functions/integrate-with-model-providers",
                "label": "Integrate with Model Providers"
              },
              {
                "type": "doc",
                "id": "tutorials/collection-api/function/model-based-embeding-functions/openai",
                "label": "OpenAI"
              },
              {
                "type": "doc",
                "id": "tutorials/collection-api/function/model-based-embeding-functions/voyage-ai",
                "label": "Voyage AI"
              },
              {
                "type": "doc",
                "id": "tutorials/collection-api/function/model-based-embeding-functions/cohere",
                "label": "Cohere"
              }
            ]
          },
          ...
          {
            "type": "category",
            "label": "Model-based Rankers",
            "items": [
              {
                "type": "doc",
                "id": "tutorials/collection-api/function/model-based-rankers/cohere-ranker",
                "label": "Cohere Ranker"
              },
              {
                "type": "doc",
                "id": "tutorials/collection-api/function/model-based-rankers/voyage-ai-ranker",
          ...
          {
            "type": "doc",
            "id": "tutorials/collection-api/function/hosted-models",
            "label": "Hosted Models"
          }
        ]
      },
    ...
    "items": [
        ...
        "items": [
          {
            ...
            "items": [
              {
                "type": "doc",
                "id": "tutorials/platform/data-management/storage-integration/integrate-with-aws-s3",
                "label": "Integrate with AWS S3"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/data-management/storage-integration/integrate-with-gcp",
                "label": "Integrate with Google Cloud Storage"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/data-management/storage-integration/integrate-with-azure-blob-storage",
          ...
          },
          {
            ...
            "items": [
              {
                "type": "doc",
                "id": "tutorials/platform/data-management/volume/managed-volumes",
                "label": "Managed Volumes"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/data-management/volume/external-volumes",
        ...
        "items": [
          ...
          },
          {
            ...
            "items": [
              {
                "type": "doc",
                "id": "tutorials/platform/compute-resource-management/global-cluster/global-cluster-explained",
                "label": "Global Cluster Explained"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/compute-resource-management/global-cluster/create-global-cluster",
                "label": "Create Global Cluster"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/compute-resource-management/global-cluster/connect-to-global-cluster",
                "label": "Connect to Global Cluster"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/compute-resource-management/global-cluster/switchover-and-failover",
                "label": "Switchover and Failover"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/compute-resource-management/global-cluster/scale-global-cluster",
                "label": "Scale Global Cluster"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/compute-resource-management/global-cluster/monitor-global-cluster",
                "label": "Monitor Global Cluster"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/compute-resource-management/global-cluster/manage-global-cluster",
        ...
        "items": [
          ...
          },
          {
            ...
            "items": [
              {
                "type": "doc",
                "id": "tutorials/platform/migrations/migrate-from-milvus/via-endpoint",
                "label": "Migrate from Milvus to Zilliz Cloud Via Endpoint"
              },
              {
                "type": "doc",
              ...
              {
                "type": "doc",
                "id": "tutorials/platform/migrations/migrate-from-milvus/via-backup-tool",
                "label": "Migrate from Milvus to Zilliz Cloud Via Backup Tool"
              }
            ]
          },
          {
            "type": "category",
            "label": "Migrate from External Sources",
            "items": [
              {
                "type": "doc",
                "id": "tutorials/platform/migrations/migrate-from-external-sources/external-migration-basics",
                "label": "External Migration Basics"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/migrations/migrate-from-external-sources/migrate-from-pinecone",
                "label": "Migrate from Pinecone to Zilliz Cloud"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/migrations/migrate-from-external-sources/migrate-from-qdrant",
                "label": "Migrate from Qdrant to Zilliz Cloud"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/migrations/migrate-from-external-sources/migrate-from-elasticsearch",
                "label": "Migrate from Elasticsearch to Zilliz Cloud"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/migrations/migrate-from-external-sources/migrate-from-tencent-cloud",
                "label": "Migrate from PostgreSQL to Zilliz Cloud"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/migrations/migrate-from-external-sources/migrate-from-pgvector",
                "label": "Migrate from Tencent Cloud to Zilliz Cloud"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/migrations/migrate-from-external-sources/migrate-from-opensearch",
                "label": "Migrate from OpenSearch to Zilliz Cloud"
              }
            ]
          },
          {
      ...
      },
      {
        ...
        "items": [
          ...
          {
            "type": "doc",
            "id": "tutorials/platform/backup-and-restore/backup-to-other-regions",
          ...
          {
            "type": "doc",
            "id": "tutorials/platform/backup-and-restore/export-backup-files",
            "label": "Export Backup Files"
          },
          {
            "type": "doc",
        ...
        "items": [
          ...
          },
          {
            ...
            "items": [
              {
                "type": "doc",
                "id": "tutorials/platform/metrics-and-alerts/integrate-monitors/integrate-with-datadog",
                "label": "Integrate with Datadog"
              },
              {
                "type": "doc",
      ...
      },
      {
        ...
        "link": {
          "type": "doc",
          "id": "tutorials/platform/payment-billing/payment-billing"
        },
        "items": [
          {
            "type": "category",
            ...
            "items": [
              {
                "type": "doc",
                "id": "tutorials/platform/payment-billing/understand-cost/dedicated-cluster-cost",
                "label": "On-Demand Cluster Cost"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/payment-billing/understand-cost/serverless-cluster-cost",
                "label": "Storage Request Cost"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/payment-billing/understand-cost/storage-cost",
                "label": "Dedicated Cluster Cost"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/payment-billing/understand-cost/data-transfer-cost",
                "label": "Serverless Cluster Cost"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/payment-billing/understand-cost/audit-log-cost",
                "label": "Storage Cost"
              },
              {
                "type": "doc",
                "id": "tutorials/platform/payment-billing/understand-cost/audit-logs-cost",
                "label": "Audit Logs Cost"
              }
            ]
          },
          {
            "type": "doc",
            "id": "tutorials/platform/payment-billing/subscribe-by-adding-credit-card",
            "label": "Subscribe by Adding Credit Card"
          },
          {
            "type": "doc",
            "id": "tutorials/platform/payment-billing/subscribe-on-aws-marketplace",
            "label": "Subscribe on AWS Marketplace"
          },
          {
            "type": "doc",
            "id": "tutorials/platform/payment-billing/subscribe-on-gcp-marketplace",
            "label": "Subscribe on Google Cloud Marketplace"
          },
          {
            "type": "doc",
            "id": "tutorials/platform/payment-billing/subscribe-on-azure-marketplace",
            "label": "Subscribe on Azure Marketplace"
          },
          {
            "type": "doc",
            "id": "tutorials/platform/payment-billing/advance-pay",
            "label": "Use Advance Pay"
          },
          {
            "type": "doc",
            "id": "tutorials/platform/payment-billing/view-invoice",
            "label": "Invoices"
          },
          {
            "type": "doc",
            "id": "tutorials/platform/payment-billing/analyze-cost",
            "label": "Analyze Cost"
          }
        ]
      }
    ...
    "items": [
      {
        ...
        "items": [
          {
            "type": "doc",
            "id": "tutorials/resources/resource-planning/select-zilliz-cloud-service-plans",
            "label": "Detailed Plan Comparison"
          },
          {
            "type": "doc",
          ...
          {
            "type": "doc",
            "id": "tutorials/resources/resource-planning/cloud-providers-and-regions",
      ...
      },
      {
        ...
        "items": [
          {
            "type": "doc",
            "id": "tutorials/resources/best-practices/cost-optimization",
      ...
      {
        "type": "doc",
        "id": "tutorials/resources/feature-availability",
