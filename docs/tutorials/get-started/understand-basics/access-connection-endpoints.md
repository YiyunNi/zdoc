...
<table>
   <tr>
     ...
     <th><p><strong>Project Endpoint (On-Demand)</strong></p></th>
...
## Connect to an on-demand cluster\{#connect-to-an-on-demand-cluster}
