...
- You have integrated your object storage bucket with Zilliz Cloud.
    ...
    For details, refer to AWS, GCP, and Azure docs in [Integrate with Third Parties](./integrate-with-third-parties).
...
Before conducting DQL operations, such as search, query, get, and hybrid search, you need to create a session to attach the compute resources of an on-demand cluster. For details, refer to [DQL Operations in External Collections](./dql-sessions-external-collection).
