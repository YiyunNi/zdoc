...
Indexing CU cost measures compute resources consumed when you build indexes for data in both [managed](null) and [external collections](./external-collection) in on-demand compute.
