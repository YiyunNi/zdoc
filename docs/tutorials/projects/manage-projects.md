...
If your project is on the **Business Critical** plan, you can add more regions to your project. Your project must be a multi-regional one if you need to use the [Global Cluster](./global-cluster) feature.
...
Before you delete a project, you must drop all [clusters](./manage-cluster#drop) and [volumes](./volume) within the project.
