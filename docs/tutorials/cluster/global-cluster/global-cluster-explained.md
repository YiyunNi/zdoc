...
- **Unsupported features**
    ...
    - Setting up a private global endpoint is not supported. The global endpoint requires public internet access. However, you can still [set up a private endpoint](./setup-a-private-link) for each individual cluster.
