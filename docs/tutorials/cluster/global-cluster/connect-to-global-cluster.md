...
- Via the **public endpoints** of the primary or secondary cluster in a global cluster
...
<table>
   ...
   <tr>
     ...
     <td><p>Routed to the nearest available cluster based on latency</p></td>
   ...
   <tr>
     ...
     <td><p>Supported. You can disable the public endpoint and connect via private endpoint instead. See <a href="./setup-a-private-link-aws#manage-internet-access-to-your-clusters">Manage internet access to your clusters</a></p></td>
   </tr>
   <tr>
...
If you have configured a private endpoint, you can choose to disable the public endpoint for greater security. For details, see [Manage internet access to your clusters](./setup-a-private-link-aws#manage-internet-access-to-your-clusters).
