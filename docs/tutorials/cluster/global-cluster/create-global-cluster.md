...
1. Initializes replication once provisioning completes. Data from the primary is replicated to each secondary cluster.

1. All primary and secondary clusters transition to **RUNNING** once replication catches up.
