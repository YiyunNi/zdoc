...
<table>
   ...
   <tr>
     <td><ul><li><p>Manage all projects in the organization</p></li><li><p>Manage <a href="./payment-billing">payments & billing</a></p></li><li><p>Manage <a href="./manage-api-keys">API keys</a></p></li><li><p>Manage <a href="./manage-organization-users">organization users</a></p></li><li><p>Manage <a href="./metrics-and-alerts">alerts</a></p></li><li><p>View <a href="./view-activities">activities</a></p></li><li><p>Manage <a href="./undefined">organization settings</a></p></li><li><p>Use <a href="./use-recycle-bin">recycle bin</a></p></li><li><p>Plus all the privileges of a <a href="./manage-project-users#project-admin">Project Admin</a> and a <a href="./cluster-roles#built-in-cluster-roles">Cluster Admin</a> roles</p></li></ul></td>
...
<table>
   ...
   <tr>
     <td><ul><li><p>Manage <a href="./payment-billing">payments & billing</a></p></li><li><p>View <a href="./manage-api-keys">API keys</a></p></li><li><p>Invite <a href="./manage-organization-users">organization users</a></p></li><li><p>View <a href="./undefined">organization settings</a></p></li></ul></td>
...
<table>
   ...
   <tr>
     <td><ul><li><p>View <a href="./manage-api-keys">API keys</a></p></li><li><p>Invite <a href="./manage-organization-users">organization users</a></p></li><li><p>View <a href="./undefined">organization settings</a></p></li></ul></td>
     ...
     <td><p>The data plan privileges are determined by <a href="./manage-project-users#invite-a-user-to-a-project">project</a> and <a href="./cluster-roles">cluster</a> roles</p></td>
   </tr>
</table>
