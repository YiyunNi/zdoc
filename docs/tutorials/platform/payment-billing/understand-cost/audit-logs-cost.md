...
slug: /audit-logs-cost
sidebar_label: "Audit Logs Cost"
beta: FALSE
added_since: FALSE
last_modified: FALSE
...
- [Audit logs CU cost](./audit-logs-cost#audit-logs-cu-cost): the cost of the computer resources consumed by audit log collection and processing

- [Data transfer cost](./audit-logs-cost#data-transfer-cost): the cost of forwarding logs to your object storage.
...
For details on data transfer pricing, see [Data Transfer](./data-transfer-cost_1).
