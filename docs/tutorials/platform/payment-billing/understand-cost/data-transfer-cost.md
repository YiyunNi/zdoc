...
sidebar_label: "Serverless Cluster Cost"
beta: FALSE
added_since: FALSE
last_modified: FALSE
...
- Vector database costs for both [read](./data-transfer-cost#vector-database-costs-read) and [write](./data-transfer-cost#vector-database-costs-write) operations

- [Storage costs](./data-transfer-cost#storage-cost)

In addition to the two primary billing items above, the following optional add-on charges may apply:

- [Data transfer cost](./data-transfer-cost_1)

- [Audit log cost](./audit-logs-cost)
...
For details, see [Storage](./audit-log-cost).
