...
<table>
   ...
   <tr>
     <td><p><a href="./migrate-from-tencent-cloud">PostgreSQL</a></p></td>
     <td><p>Relational database</p></td>
     <td><p>Vector extension (pgvector) support</p></td>
   </tr>
   <tr>
     <td><p><a href="./migrate-from-pgvector">Tencent Cloud VectorDB</a></p></td>
...
- [Migrate from PostgreSQL to Zilliz Cloud](./migrate-from-tencent-cloud)

- [Migrate from Tencent Cloud to Zilliz Cloud](./migrate-from-pgvector)
