...
If your project is on the **Business Critical** plan, you can add more regions to your project. Your project must be a multi-regional one if you need to use the Global Cluster feature.
...
To rename a project, you must be an [Organization Owner](./manage-organization-users). You can rename a project via the web console.

<Supademo id="cmhiwa69y5zk2fatiw4ou24k6?utm_source=link" title=""  />

## Delete a project\{#delete-a-project}

To delete a project, you must be an [Organization Owner](./manage-organization-users). 
