...
- Type and Description: The purpose and information of the job. There are certain types of job on this page.
    ...
    <table>
       ...
       <tr>
         <td><p><a href="./manage-collections-console#create-a-managed-collection">Clone Collection</a></p></td>
         <td><p>Make a full copy of the collection with both its schema and data</p></td>
       </tr>
       <tr>
         <td><p><a href="./manage-collections-console#create-a-managed-collection">Create Sample Collection</a></p></td>
