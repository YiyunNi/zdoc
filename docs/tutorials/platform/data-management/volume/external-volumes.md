...
Before creating an external volume, you need to create a [storage integration](./storage-integration). Note that the storage integration should be in the same cloud provider and region as the external volume you wish to create.
    ...
    1. Set the volume configurations.
        ...
        <table>
           ...
           <tr>
             ...
             <td><p><a href="./storage-integration">Storage integration</a> is the credential object that encapsulates the access configuration for your cloud storage.</p><p>Path is a pointer to where your data is placed. (Eg. <code>folder/</code>)</p></td>
           </tr>
        </table>
