...
- **Via SDK**
    ...
    <table>
       ...
       <tr>
         ...
         <td><p>If this parameter is omitted, a managed cluster will be created by default.</p></td>
       </tr>
    </table>
    ...
    1. Set the volume configurations.
        ...
        <table>
           ...
           <tr>
             ...
             <td><ul><li><p>If you only want to try out the manged volume feature, create a <strong>free trial volume</strong>. A free trial volume can be created <strong>once per organization</strong> and has limits on capacity and file uploads. For details, see the comparison table in the <a href="./managed-volumes#billing">Billing</a> section.</p></li><li><p>For production workloads, create a <strong>pay-as-you-go volume</strong>.</p></li></ul></td>
           </tr>
           <tr>
...
- Using a pay-as-you-go volume incurs charges.
    ...
    - To understand how volume charges are calculated, see [Storage Cost](./audit-log-cost).
