...
notebook: FALSE
description: "You can create multiple databases to separate data by environment (staging vs. production), by team, by tenant, or by business domain. | Cloud"
type: origin
...
## Create database in on-demand compute  | PUBLIC\{#create-database-in-on-demand-compute}
...
- **Via web console**
    ...
    ![HolVwvjq4hlT3VbqImmclRRYnkf](https://zdoc-images.s3.us-west-2.amazonaws.com/HolVwvjq4hlT3VbqImmclRRYnkf.png)
