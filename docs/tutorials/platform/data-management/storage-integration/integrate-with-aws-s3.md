...
sidebar_label: "Integrate with AWS S3"
beta: FALSE
added_since: FALSE
last_modified: FALSE
...
1. In the dialog box that appears, configure **Basic Settings**:
    ...
    - **Bucket Permission**: Select the level of access Zilliz Cloud has to your S3 bucket. The following table explains the options.
        ...
        <table>
           ...
           <tr>
             <td><p>Read only</p></td>
             <td><p>Zilliz Cloud can only read files from the bucket. Use for <a href="./external-volumes">external volumes</a> that back external collections.</p></td>
           </tr>
           <tr>
