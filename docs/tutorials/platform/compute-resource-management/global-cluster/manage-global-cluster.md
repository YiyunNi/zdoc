...
<table>
   ...
   <tr>
     <td><p>Billing</p></td>
     <td><p><a href="./data-transfer-cost_1">Data transfer</a> charges stop. The remaining cluster is billed as a regular <a href="./storage-cost">Dedicated cluster</a>.</p></td>
   </tr>
</table>
