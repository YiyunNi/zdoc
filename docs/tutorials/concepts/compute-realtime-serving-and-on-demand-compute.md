...
slug: /compute-realtime-serving-and-on-demand-compute
...
For details on how to create a Serving Cluster, see [Create Cluster](./create-cluster#create-a-serving-cluster).
