...
sidebar_label: "Integrate with Model Providers"
beta: PUBLIC
added_since: FALSE
last_modified: FALSE
...
- **Model-based Rankers**: Re-rank search results using external reranking models. For details, refer to [Model-based Rankers](./model-based-rankers).
...
- Data transfer costs when data is sent for embedding or reranking. For details, refer to [Data Transfer Cost](./data-transfer-cost_1).
