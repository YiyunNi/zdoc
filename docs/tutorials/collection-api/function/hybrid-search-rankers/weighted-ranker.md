...
<table>
   ...
   <tr>
     ...
     <td><p>Yes</p></td>
     <td><p>Array of weights corresponding to each search path; values ∈ [0,1].</p><p>For details, refer to <a href="./weighted-ranker#mechanism-of-weighted-ranker">Mechanism of Weighted Ranker</a>.</p></td>
     <td><p><code>[0.1, 0.9]</code></p></td>
   </tr>
   <tr>
     <td><p><code>params.norm_score</code></p></td>
     <td><p>No</p></td>
     <td><p>Whether to normalize raw scores (using arctan) before weighting.</p><p>For details, refer to <a href="./weighted-ranker#mechanism-of-weighted-ranker">Mechanism of Weighted Ranker</a>.</p></td>
