...
<table>
   ...
   <tr>
     <td><p><code>type</code></p></td>
     <td><p>The resource type. Use <code>"remote"</code> for a file registered via <code>add_file_resource</code>. For the <code>"local"</code> variant used in self-hosted deployments, refer to <a href="./manage-file-resources">Manage File Resources</a>.</p></td>
   </tr>
   <tr>
