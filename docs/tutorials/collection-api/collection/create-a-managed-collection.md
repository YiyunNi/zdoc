---
title: "Create a Managed Collection | Cloud"
slug: /create-a-managed-collection
sidebar_label: "Create a Managed Collection"
beta: FALSE
added_since: FALSE
last_modified: FALSE
...
- [Create schema](./create-a-managed-collection#create-schema)

- [Set index parameters](./create-a-managed-collection#optional-set-index-parameters) (Optional)

- [Create collection](./create-a-managed-collection#create-a-collection)
