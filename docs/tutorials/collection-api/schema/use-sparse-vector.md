...
Once the sparse vector and index settings are complete, you can create a collection that contains sparse vectors. The example below uses the [`create_collection`](./create-a-managed-collection) method to create a collection named `my_collection`.
