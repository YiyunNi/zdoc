...
sidebar_label: "Performance Benchmarking with VectorDBBench"
beta: FALSE
added_since: FALSE
last_modified: FALSE
...
- [Create at least one cluster](/docs/create-cluster). Zilliz Cloud provides free clusters for you to quickly get onboard and start exploring Zilliz Cloud vector database.
