...
- To enable CMEK on existing clusters compatible with Milvus v2.5.x, back up the data and restore it to a new cluster compatible with Milvus v2.6.x.  Upgrading clusters does not encrypt the data before the upgrade.

<Admonition type="info" icon="📘" title="Notes">

<p>Currently, CMEK is available only in AWS regions.</p>
